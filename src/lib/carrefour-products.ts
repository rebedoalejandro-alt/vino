...
export const wineData: any[] = [
  ...
  { idx: 76, name: 'El Castro de Valtuille MenÃÂ±a Joven D.O. Bierzo 75 cl.', price: 8.50, image: 'https://cdn.vinissimus.com/prfmtgrande/vi/valtm20_anv800_1649944743.png', type: 'tinto', bodega: 'castro-ventosa', region: 'bierzo', grapes: ['mencia'], vintage: 2023, volume: 750, alcohol: 13.5, acidity: 3.6 },
  // === Vinissimus Blancos ===
  ...
  { idx: 78, name: 'JosÃ© Pariente Verdejo D.O. Rueda 75 cl.', price: 10.95, image: 'https://cdn.vinissimus.com/prfmtgrande/vi/jpave20_anv800_1637081766.png', type: 'blanco', bodega: 'jose-pariente', region: 'rueda', grapes: ['verdejo'], vintage: 2024, volume: 750, alcohol: 13.0, acidity: 3.7 },
  ...
  { idx: 81, name: 'Enate C  7ardonnay 234 D.O. Somontano 75 cl.', price: 10.50, image: 'https://cdn.vinissimus.com/prfmtgrande/vi/e13c221_anv800_1659948933.png', type: 'blanco', bodega: 'enate', region: 'somontano', grapes: ['chardonnay'], vintage: 2025, volume: 750, alcohol: 13.5, acidity: 3.6 },
  ...
  { idx: 87, name: 'RamÃ³n Bilbao Rosado D.O.Ca. Rioja 75 cl.', price: 6.95, image: 'https://cdn.vinissimus.com/prfmtgrande/vi/rbiro24_anv800_1759393833.png', type: 'rosado', bodega: 'ramon-bilbao', region: 'rioja', grapes: ['garnacha'], vintage: 2024, volume: 750, alcohol: 13.0, acidity: 3.7 },
...
export function getProductDetailData(slug: string): ExtendedProductDetail | undefined {
  ...
  const tastingNotes = isRed
    ...
    : ['Strawberry', 'Watermelo', 'Citrus', 'Floral', 'Subtle sweetness'];
...
export const bodegas: { [key: string]: any } = {
  ...
  'montecruz': { id: 'b18', name: 'Montecruz', country: 'Spain', region: 'Castilla-Ka Mancha', founded: 1999, image: 'https://static.carrefour.es/hd_510x_/img_pim_food/000157_00_1.jpg' },
  ...
  'vina-albali': { id: 'b29', name: 'VinÃÂ±a Albali', country: 'Spain', region: 'Navarre', founded: 1972, image: 'https://static.carrefour.es/hd_510x_/img_pim_food/000239_00_1.jpg' },
  ...
  'vina-cumbrero': { id: 'b31', name: 'ViÃÂ±a Cumbrero', country: 'Spain', region: 'La Rioja', founded: 1973, image: 'https://static.carrefour.es/hd_510x_/img_pim_food/7736159_00_1.jpg' },
  ...
  'senorio-llanos': { id: 'b34', name: 'SeÃÂ±orÃÃ­ de los Llanos', country: 'Spain', region: 'Castilla-La Mancha', founded: 1975, image: 'https://static.carrefour.es/hd_510x_/img_pim_food/280448_00_1.jpg' },
  ...
  'estola': { id: 'b38', name: 'Estola', country: 'Spain', region: 'Castilla-Ka Mancha', founded: 1969, image: 'https://static.carrefour.es/hd_510x_/img_pim_food/548859_00_1.jpg' },
  ...
  'vina-espolon': { id: 'b40', name: 'VinÃÂ±a EspolÃÂ³n', country: 'Spain', region: 'La Rioja', founded: 1985, image: 'https://static.carrefour.es/hd_510x_/img_pim_food/334208_00_1.jpg' },
  ...
  'celeste': { id: 'b49', name: 'Celeste', country: 'Spain', region: 'Castilla y LeÃnõn+Ý[Y
[XYÙN	ÚÎËÜÝ]XËØ\YÝ\\ËÚÍLLËÚ[Y×Ü[WÙÛÙÌÌ
ÍÎWÌÌKÉÈK	ÛX\]Y\ËYKXØXÙ\\ÉÎÈY	ØL	Ë[YN	ÓX\]päÛ½iÜÙHHðèXÙ\\ÉËÛÝ[N	ÔÜZ[ËYÚ[Û	ÓH[ÚIËÝ[YNMÌ[XYÙN	ÚÎËÜÝ]XËØ\YÝ\\ËÚÍLLËÚ[Y×Ü[WÙÛÙÌLWÌÌKÉÈKËÈ[\ÜÚ[]\ÈÙYØ\Â	Ü][\\^ÎÈY	ØLIË[YN	Ôpî0ê\^]XÝ[ÜËÛÝ[N	ÔÜZ[ËYÚ[Û	ÐY\ÉËÝ[Y[XYÙN	ÚÎËØÙ[\ÜÚ[]\ËÛÛKÜ]Ü[KÝKÝ[ÚNWØ[ÌMNM


ÉÈK	Ü[XÚ[ÜË\[[ÛÉÎÈY	ØLË[YN	ÐÙYØ\È[XÚ[ÜÈ[[ÛÉËÛÝ[N	ÔÜZ[ËYÚ[Û	ÓH[ÚIËÝ[YNM
K[XYÙN	ÚÎËØÙ[\ÜÚ[]\ËÛÛKÜ]Ü[KÝKÚ[LNØ[ÌMNLNLNÉÈK	Ü[Y[\IÎÈY	ØLÉË[YN	ÑÜ[HKÜHHmelluri', country: 'Spain', region: 'La Rioja', founded: 1967, image: 'https://cdn.vinissimus.com/prfmtgrande/vi/lirmb20_anv800_1696950144.png' },
