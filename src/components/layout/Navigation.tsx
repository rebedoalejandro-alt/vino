            ...
            {navItems.map((item) => (
              ...
              >
                ...
                {megaMenus[item.label] && openMenu === item.label && (
                  <div
                    className="absolute left-0 top-full bg-white text-gray-900 shadow-xl rounded-b-lg opacity-0 transition-opacity duration-150 animate-in z-50"
                    style={{
                    ...
                    onMouseLeave={handleMouseLeave}
                  >
                    <div className="flex gap-8 p-6" style={{ minWidth: 'max-content' }}>
                      {megaMenus[item.label].map((column) => (
                        <div key={column.title} className="min-w-[120px]">
                          <h3 className="text-xs font-bold uppercase mb-4 text-yellow-600 whitespace-nowrap">
                            {column.title}
                          </h3>
                          <ul className="space-y-2">
                            {column.items.map((menuItem) => (
                              <li key={menuItem.href}>
                                <Link
                                  href={menuItem.href}
                                  className="text-sm text-gray-700 hover:text-gray-900 hover:font-semibold transition-all whitespace-nowrap"
                                >
                                  {menuItem.label}
                                </Link>
                              </li>
